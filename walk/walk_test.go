...
func TestWalk(t *testing.T) {
	for n, test := range [...]struct {
		...
		{ // 96
			...
			func(f *bash.File) bash.Type {
				return &f.Lines[0].Statements[0].Pipeline.CommandOrCompound.Compound.CaseCompound.Matches[0].Patterns[0]
			},
			[]string{"File", "Line", "Statement", "Pipeline", "CommandOrCompound", "Compound", "CaseCompound", "PatternLines", "Word"},
		},
		{ // 97
			"case a in b|c) d;;esac",
			func(f *bash.File) bash.Type {
				return &f.Lines[0].Statements[0].Pipeline.CommandOrCompound.Compound.CaseCompound.Matches[0].Patterns[1]
			},
			[]string{"File", "Line", "Statement", "Pipeline", "CommandOrCompound", "Compound", "CaseCompound", "PatternLines", "Word"},
		},
		{ // 98
			"case a in b|c) d;;esac",
			func(f *bash.File) bash.Type {
				return &f.Lines[0].Statements[0].Pipeline.CommandOrCompound.Compound.CaseCompound.Matches[0].Lines
			},
		...
		{ // 114
			"[[ a == b$c ]]",
			func(f *bash.File) bash.Type {
				return &f.Lines[0].Statements[0].Pipeline.CommandOrCompound.Compound.TestCompound.Tests.Pattern.Parts[0]
			},
			[]string{"File", "Line", "Statement", "Pipeline", "CommandOrCompound", "Compound", "TestCompound", "Tests", "Pattern", "WordPart"},
		},
		{ // 115
			"[[ a == b$c ]]",
			func(f *bash.File) bash.Type {
				return &f.Lines[0].Statements[0].Pipeline.CommandOrCompound.Compound.TestCompound.Tests.Pattern.Parts[1]
			},
			[]string{"File", "Line", "Statement", "Pipeline", "CommandOrCompound", "Compound", "TestCompound", "Tests", "Pattern", "WordPart"},
		},
		{ // 116
			"function a { b; }",
			func(f *bash.File) bash.Type {
				return &f.Lines[0].Statements[0].Pipeline.CommandOrCompound.Compound.FunctionCompound.Body
			},
			[]string{"File", "Line", "Statement", "Pipeline", "CommandOrCompound", "Compound", "FunctionCompound", "Compound"},
		},
		{ // 117
			"a() { b; }",
			func(f *bash.File) bash.Type {
